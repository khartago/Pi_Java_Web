...
public class MaterielController {
    ...
    private void handleSupprimer() {
        ...
        if (selected != null) {
            ...
            confirm.setHeaderText("Supprimer le mat├®riel");
            confirm.setContentText("Voulez-vous vraiment supprimer le mat├®riel " + selected.getNom() + " ?");
            ...
            if (result.isPresent() && result.get() == ButtonType.OK) {
                if (materielDAO.delete(selected.getIdMateriel())) {
                    ...
                    error.setHeaderText("Erreur lors de la suppression du mat├®riel");
    ...
    private void handleVoirProduits() {
        try {
            ...
            // Ajouter explicitement le CSS si n├®cessaire
    ...
    private void openMaterielForm(Materiel materiel) {
        try {
            ...
            stage.setTitle(materiel == null ? "Ajouter un mat├®riel" : "Modifier le mat├®riel");
            stage.showAndWait();
            loadMateriels();
        } catch (IOException e) {
            e.printStackTrace();
