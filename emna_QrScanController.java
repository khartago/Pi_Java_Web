...
public class QrScanController {
    ...
    private void initialize() {
        ...
        dateCol.setCellValueFactory(cell -> {
            ...
            return new javafx.beans.property.SimpleStringProperty(
                    cell.getValue().getDateEvenement().toString()
            );
        });
        selectedFileLabel.setText("Aucun fichier s├®lectionn├®");
        resultLabel.setText("");
    ...
    private void handleChooseImage() {
        ...
        try {
            ...
            if (p == null) {
                resultLabel.setText("Aucun produit trouv├® pour l'ID " + id);
                clearProduit();
                return;
            }
            ...
            e.printStackTrace();
            resultLabel.setText("Erreur lors du d├®codage du QR code.");
            clearProduit();
        }
    }
    ...
    private void handleOpenQrFolder() {
        try {
            ...
            if (Desktop.isDesktopSupported()) {
                ...
                resultLabel.setText("Ouverture du dossier non support├®e sur ce syst├¿me.");
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void fillProduit(Produit p) {
        ...
        historiqueTable.setItems(FXCollections.observableArrayList(
                historiqueDAO.getByProduit(p.getIdProduit())
        ));
    }
