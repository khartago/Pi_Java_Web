...
/**
 * Contr├┤leur pour la page de statistiques
...
public class StatisticsController {
    ...
    private void loadStatistics() {
        ...
        // Mise ├á jour des indicateurs ├á risque
        ...
        totalValueLabel.setText(String.format("%.2fÔé¼", statisticsService.getTotalStockValue()));

        // Mise ├á jour des graphiques
        updateStockChart();
        updateUnitsChart();
    }
    ...
    private void setupCharts() {
        // Stock Chart
        if (stockChart != null) {
            stockChart.setTitle("Top 10 Produits par Quantit├®");
            stockChart.setAnimated(true);
        }

        // Units Chart
        if (unitsChart != null) {
            unitsChart.setTitle("Distribution par Unit├®");
            unitsChart.setAnimated(true);
        }
    }

    /**
     * Mise├á jour du graphique des stocks
     */
    ...
    /**
     * Mise ├á jour du graphique des unit├®s
     */
    ...
    private void exportToPDF() {
        ...
        if (selectedFile != null) {
            try {
                ...
                showInfo("Succ├¿s", "Rapport PDF g├®n├®r├® avec succ├¿s:\n" + selectedFile.getAbsolutePath());
            } catch (Exception e) {
                e.printStackTrace();
                showError("Erreur", "Erreur lors de la g├®n├®ration du PDF: " + e.getMessage());
            }
        }
    }

    /**
     * Retour ├á la page pr├®c├®dente
     */
    @FXML
    private void goBack() {
        try {
            ...
            e.printStackTrace();
            showError("Erreur", "Impossible de retourner ├á la page pr├®c├®dente.");
        }
    }
