...
public class MarketplaceDetailController {
    ...
    private void refresh() {
        ...
        stockLabel.setText("Quantit├® : " + produit.getQuantite());
        uniteLabel.setText("Unit├® : " + produit.getUnite());
        expLabel.setText("Expiration : " + (produit.getDateExpiration() == null ? "-" : produit.getDateExpiration()));
        ...
        if (produit.getDateExpiration() != null) {
            ...
            if (!produit.getDateExpiration().isBefore(today) && !produit.getDateExpiration().isAfter(today.plusDays(7))) {
                badgeLabel.setText("Expire bient├┤t");
