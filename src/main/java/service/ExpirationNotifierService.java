...
public class ExpirationNotifierService {
    ...
    private String buildTextBody(LocalDate today, int daysBefore,
        ...
        sb.append("Bonjour,\n\n");
        sb.append("TechFarm - Contrôle des expirations\n");
        sb.append("Date du contrôle: ").append(today).append("\n\n");
        ...
        if (!expired.isEmpty()) {
            sb.append("Produits déjà expirés:\n");
        ...
        sb.append("TechFarm (Système de gestion des stocks)\n");
        return sb.toString();
    }

    // ✅ Email HTML design pro "TechFarm"
    private String buildHtmlBody(LocalDate today, int daysBefore,
                  ...
                  <div style="max-width:760px; margin:0 auto; padding:24px;">
                    ...
                    <div style="background:white; border-radius:0 0 14px 14px; padding:22px; box-shadow:0 6px 18px rgba(0,0,0,0.06);">
                      ...
                      <p style="margin:0 0 16px 0; font-size:14px;">
                        Voici le rapport d’expiration du <b>%s</b> (fenêtre <b>J+%d</b>).
                      </p>
                      ...
                      <div style="display:flex; gap:12px; flex-wrap:wrap; margin:16px 0 18px 0;">
                        <div style="flex:1; min-width:220px; border:1px solid #E8E8E8; border-radius:12px; padding:12px;">
                          <div style="font-size:12px; color:#667085;">Expire bientôt</div>
                          <div style="font-size:22px; font-weight:700; color:%s;">%d</div>
                        </div>
                        <div style="flex:1; min-width:220px; border:1px solid #E8E8E8; border-radius:12px; padding:12px;">
                          <div style="font-size:12px; color:#667085;">Déjà expirés</div>
                          <div style="font-size:22px; font-weight:700; color:%s;">%d</div>
                        </div>
                      </div>
        ...
        if (!soon.isEmpty()) {
            html.append("""
                    <h3 style="margin:0 0 10px 0; font-size:16px; color:%s;">Produits qui expirent bientôt</h3>
                    <table style="width:100%%; border-collapse:collapse; font-size:13px; margin-bottom:18px;">
                      <thead>
                        <tr>
                          ...
                          <th align="left" style="padding:10px; background:%s; border:1px solid #E8E8E8;">Quantité</th>
        ...
        if (!expired.isEmpty()) {
            html.append("""
                    <h3 style="margin:0 0 10px 0; font-size:16px; color:%s;">Produits déjà expirés</h3>
        ...
        html.append("""
                      <div style="margin-top:16px; padding-top:14px; border-top:1px solid #E8E8E8; font-size:12px; color:#667085;">
                        Cet email a été généré automatiquement par <b>TechFarm</b> (Gestion Stock & Expirations).<br/>
